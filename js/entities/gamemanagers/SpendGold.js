...
game.SpendGold = Object.extend({
	...
	makePurchase: function(skill){
		if(skill === 1){
			...
			game.data.gold -= ((Number(game.data.skill1) +1)*10);
			...
			game.data.gold -= ((Number(game.data.skill2) +1)*10);
			//increases skill level
			game.data.skill2 += 1;
		}
		else if(skill === 3){
			//gold amount subtracted by cost of skill 3
			game.data.gold -= ((Number(game.data.skill3) +1)*10);
			//increases skill level
			game.data.skill3 += 1;
		}
		else if(skill === 4){
			//gold amount subtracted by cost of ability 1
			game.data.gold -= ((Number(game.data.ability1) +1)*10);
			//increases ability level
			game.data.ability1 += 1;
		}
		else if(skill === 5){
			//gold amount subtracted by cost of ability 2
			game.data.gold -= ((Number(game.data.ability2) +1)*10);
			//increases ability level
			game.data.ability2 += 1;
		}
		else if(skill === 6){
			//gold amount subtracted by cost of ability 3
			game.data.gold -= ((Number(game.data.ability3) +1)*10);
			//increases ability level
